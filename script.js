...
function settime(){
    ...
    if(y==hour){
        document.getElementById("imagecontainer").style.backgroundImage="url(https://github.com/Raghavender-lonka/Digital_Clock2/blob/main/Assets/lunch.png?raw=true)"
